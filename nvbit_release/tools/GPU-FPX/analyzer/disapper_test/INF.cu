...
__global__ void compute(float comp, int var_1, float var_2, float var_3,
  ...
  if (comp < +1.4882E-36f / (var_2 / var_3)) {
    if (comp < (-1.3710E-36f *
                (var_4 * asinf(var_5 - (+1.8810E35f *
                                        (-1.7451E-36f - -1.8252E25f)))))) {
...
int main(int argc, char **argv) {
  ...
  compute<<<1, 1>>>(tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, tmp_6, tmp_7, tmp_8,
                    tmp_9, tmp_10, tmp_11, tmp_12, tmp_13);

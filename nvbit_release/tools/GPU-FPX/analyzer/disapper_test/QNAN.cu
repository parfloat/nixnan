...
__global__ void compute(float comp, int var_1, int var_2, float var_3,
                        float var_4, float var_5, float var_6, float *var_7,
                        float var_8, float var_9, float var_10) {
  if (comp <= asinf(+1.3463E34f)) {
    comp += (var_3 + sinhf(-0.0f));
    for (int i = 0; i < var_1; ++i) {
      comp +=
          ldexpf(atan2f(+1.5696E-42f, var_4 * var_5 - asinf(+1.2147E35f)), 2);
      comp += acosf(logf((+1.6666E-36f / -1.1833E-36f + var_6 + +1.8570E35f)));
    }
    for (int i = 0; i < var_2; ++i) {
      var_7[i] =
          (var_8 * ceilf(var_9 + logf(var_10 - -1.7568E-37f + -1.7043E26f)));

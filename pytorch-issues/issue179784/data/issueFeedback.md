...
`parfloat/parfloat-class/pytorch-nixnan/repros/k10_xlogy_zero_zero/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k10_xlogy_zero_zero/`

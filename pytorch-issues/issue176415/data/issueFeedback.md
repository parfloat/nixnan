...
`parfloat/parfloat-class/pytorch-nixnan/repros/k21_logdet_4d_nan_masking/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k21_logdet_4d_nan_masking/`

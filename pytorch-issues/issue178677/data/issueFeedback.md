...
`parfloat/parfloat-class/pytorch-nixnan/repros/k41_transformer_encoder_all_masked/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k41_transformer_encoder_all_masked/`

...
`parfloat/parfloat-class/pytorch-nixnan/repros/k37_groupnorm_compile_crash/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k37_groupnorm_compile_crash/`

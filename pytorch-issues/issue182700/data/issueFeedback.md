...
`parfloat/parfloat-class/pytorch-nixnan/repros/k40_vllm_cascade_attention/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k40_vllm_cascade_attention/`

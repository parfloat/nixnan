...
`parfloat/parfloat-class/pytorch-nixnan/repros/k8_linspace_inf_endpoint/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k8_linspace_inf_endpoint/`

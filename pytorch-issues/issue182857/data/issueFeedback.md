...
`parfloat/parfloat-class/pytorch-nixnan/repros/k38_sdpa_backward_head_dim/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k38_sdpa_backward_head_dim/`

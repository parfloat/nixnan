# Feedback for pytorch/pytorch#181692 — K36 — `nn.RReLU().eval()` under `torch.compile`
...
[pytorch-issues/issue181692/README.md](https://github.com/parfloat/nixnan/blob/pytorch-issues/pytorch-issues/issue181692/README.md)
...
**Zero events on torch 2.3.1.** The `nn.RReLU().eval()` lowering matches eager on the older Inductor. Same torch-version caveat as #182131.
...
- Issue README: [pytorch-issues/issue181692/README.md](https://github.com/parfloat/nixnan/blob/pytorch-issues/pytorch-issues/issue181692/README.md)
- Reproducer: [pytorch-issues/issue181692/data/repro.py](https://github.com/parfloat/nixnan/blob/pytorch-issues/pytorch-issues/issue181692/data/repro.py)
- Captured trace: [pytorch-issues/issue181692/data/nixnan.nnlog](https://github.com/parfloat/nixnan/blob/pytorch-issues/pytorch-issues/issue181692/data/nixnan.nnlog)
- Captured stdout: [pytorch-issues/issue181692/data/stdout.nnlog](https://github.com/parfloat/nixnan/blob/pytorch-issues/pytorch-issues/issue181692/data/stdout.nnlog)

...
`parfloat/parfloat-class/pytorch-nixnan/repros/k36_rrelu_eval_inductor/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k36_rrelu_eval_inductor/`

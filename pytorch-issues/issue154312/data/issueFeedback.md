...
`parfloat/parfloat-class/pytorch-nixnan/repros/k7_logdet_singular/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k7_logdet_singular/`

...
`parfloat/parfloat-class/pytorch-nixnan/repros/k35_compile_fp16_cast_add/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k35_compile_fp16_cast_add/`

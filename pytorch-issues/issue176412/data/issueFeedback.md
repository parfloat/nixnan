...
`parfloat/parfloat-class/pytorch-nixnan/repros/k22_erfinv_2d_negative/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k22_erfinv_2d_negative/`

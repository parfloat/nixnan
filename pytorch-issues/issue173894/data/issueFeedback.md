...
`parfloat/parfloat-class/pytorch-nixnan/repros/k11_softplus_large_beta/` on the
`main` branch.
...
- Reproducer + trace: `parfloat/parfloat-class/pytorch-nixnan/repros/k11_softplus_large_beta/`
